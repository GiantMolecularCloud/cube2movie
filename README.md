...
- [ ] Add option to zoom the cube. Simplest implementation: give BLC and TRC pixel positions to draw subcube.
- [ ] More advanced zooming: use arbitrary coordinate formats.
